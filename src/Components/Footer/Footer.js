...
const Footer = () => {
  return (
    <>
        ...
        <h4 style={{color:'white', fontSize:'1.8rem'}} className='mt-3'> made By <span className='footer-text'>Arshil</span></h4>
        <div>
        <a href="https://www.instagram.com/arshilbaig/" target="#">
        <BsInstagram style={{color:'white', fontSize:'1.8rem', margin:'0.5rem'}}/>
        </a>
        <a href="https://github.com/Arshh82/" target="#">
        <BsGithub style={{color:'white', fontSize:'1.8rem', margin:'0.5rem'}}/>
        </a>
